...
public class GreetingControllerTest extends AbstractControllerTest{
    ...
    public void testUpdateGreeting() throws Exception {
        ...
        Assert.assertEquals("failure - expected greeting text match", updateText, updatedGreeting.getText());
    ...
    public void testDeleteGreeting() throws Exception {
        ...
        Assert.assertTrue("failure - expected http response body to empty",
                content.trim().length() == 0);
